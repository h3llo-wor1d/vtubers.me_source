...
<head>
    <meta charset="utf-8">
    <title>vTubers.Me API - Documentation</title>
    <meta name="description" content="vTubers.Me - A place for vTubers, Content Creators, and their Fans to connect and stay up to date with each other.">
    <meta name="author" content="nekoli">
...
<body>
    <div class="left-menu">
        <div class="content-logo">
            <span class="label">vTubers.Me - API</span>
        </div>
        <div class="content-menu">
            <ul id="left-menu-nav">
                <li class="<?php if (empty($docs_page)) {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'login') {
                                echo ("active");
                            } ?>">
                ...
                <!-- <li class="<?php if ($docs_page == 'oauth_login') {
                                    echo ("active");
                                } ?>">
                ...
                <li class="<?php if ($docs_page == 'signup') {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'resetpassword') {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'feeds') {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'profile') {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'report_profile') {
                                echo ("active");
                            } ?>">
                ...
                <li class="<?php if ($docs_page == 'block_user') {
                                echo ("active");
                            } ?>">
