...
if (in_array($page, array('terms', 'privacy_policy', 'community_guidelines', 'cookies_policy', 'about_us', 'faqs')) != true) {
	cl_redirect("404");
}
...
$page_titles         = array(
	...
	'community_guidelines' => cl_translate('Community guidelines'),
