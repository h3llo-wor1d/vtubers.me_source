...
$(document).ready(function () {
  ...
  if ($("div#main-preloader-holder").length) {
    $("div#main-preloader-holder").fadeOut(3000, function () {
      $(this).remove();
    });
  }
  ...
  $(document).on("hide.bs.modal", "div.modal", function () {
    ...
    $("body")
      .find("div.modal-backdrop.show.d-none")
      .each(function (index, el) {
        $(this).removeClass("d-none");
      });
  });
...
function cl_bs_notify(msg = "", time = 3000, type = "primary") {
  if (cl_empty(msg)) {
    return false;
  } else {
    $('[data-el="timeline-bs-notifs"]')
      .find("div.timeline-bs-notifs__item")
      .each(function (index, el) {
        $(el).remove();
      })
      .promise()
